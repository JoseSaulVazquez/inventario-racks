...
import { pisosOficinas } from "../data/mockData"

function OficinasPisos() {
  ...
  return (
    <div className="min-h-screen bg-white p-4 sm:p-6 lg:p-8">
      <div className="mb-4 sm:mb-6 flex items-center gap-2 sm:gap-4 flex-wrap">
          ...
          <h1 className="text-[#1e3a5f] font-semibold text-xl sm:text-2xl">Oficinas</h1>
      </div>
      ...
      <div className="max-w-4xl mx-auto flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="max-w-2xl w-full grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            {pisosOficinas.map((piso) => (
              <div key={piso.id} className="flex flex-col items-center">
                <button
                  type="button"
                  onClick={() => navigate(`/rack/${piso.rackId}`)}
